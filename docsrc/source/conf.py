...
html_baseurl = "https://nickderobertis.github.io/playwright-trace-browser" + '/'
...
html_theme_options = dict(
    nav_title=project,
    base_url="https://nickderobertis.github.io/playwright-trace-browser",
    color_primary='indigo',
    color_accent='deep-purple',
    logo_icon='&#xe869',
    repo_url="https://github.com/nickderobertis/playwright-trace-browser",
    repo_name="playwright-trace-browser",
    globaltoc_depth=3,
)
...
texinfo_documents = [
    (master_doc, conf.PACKAGE_NAME, f'{conf.PACKAGE_NAME} Documentation',
     author, conf.PACKAGE_NAME, "A TUI app for exploring Playwright traces",
     'Miscellaneous'),
]
